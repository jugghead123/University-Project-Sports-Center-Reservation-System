...
public class TennisController implements Initializable {
    ...
    @FXML
    private RadioButton skyButton;
    @FXML
    private RadioButton smashButton;
    @FXML
    ...
    public void chooseCourt(){
        if(skyButton.isSelected()==false && smashButton.isSelected()==false){
        ...
        else if(skyButton.isSelected() && smashButton.isSelected())
            courtMessage.setText("Please choose one court only");
        else if (smashButton.isSelected()) {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle){
        File backgroundFile= new File("images/Capture3.PNG");

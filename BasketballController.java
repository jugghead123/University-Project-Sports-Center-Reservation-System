...
public class BasketballController implements Initializable{
    ...
    @FXML
    private RadioButton ballersButton;
    @FXML
    private RadioButton hayahButton;
    @FXML
    ...
    public void chooseCourt(){
        if(ballersButton.isSelected()==false && hayahButton.isSelected()==false){
        ...
        else if(ballersButton.isSelected() && hayahButton.isSelected())
            courtMessage.setText("Please choose one court only");
        else if (ballersButton.isSelected()) {
        ...
        else if (hayahButton.isSelected()) {
            double x=Double.parseDouble(timeoneTextField.getText());
            double y=Double.parseDouble(timetwoTextField.getText());
            if(y<x){
                y+=12;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle){
        File backgroundFile= new File("images/Capture4.PNG");
